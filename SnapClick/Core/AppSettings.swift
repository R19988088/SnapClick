...
public final class LanguageManager: ObservableObject {
    ...
    private let translations: [String: [String: String]] = [
        "en": [
            ...
            "音量": "Volume",
            "系统总音量": "System Volume",
            "启用音量控制": "Enable Volume Control",
            "正在安装音频驱动…": "Installing Audio Driver…",
            "正在启用音量控制…": "Starting Volume Control…",
            "重试音量控制": "Retry Volume Control",
            "音频驱动": "Audio Driver",
            "使用系统音量键控制内建扬声器和外接显示器": "Use the system volume keys with built-in speakers and external displays",
            "安装": "Install",
            "卸载": "Uninstall",
            "音频驱动操作失败": "Audio Driver Operation Failed",
            "软件音量": "Software Volume",
            "软件音量操作失败": "Software Volume Failed",
            "音频兼容输出": "Audio Compatibility Output",
            "音频兼容输出操作失败": "Audio Compatibility Output Failed",
            "需要 macOS 14.2 或更高版本": "Requires macOS 14.2 or later",
            "未启用": "Disabled",
            "停用": "Disable",
            "启用": "Enable",
            "当前输入法": "Current Input Method",
            "重启输入法": "Restart Input Method",
            "输入法重启失败": "Input Method Restart Failed",
        ...
        "ja": [
            ...
            "其他": "その他",
            "音频驱动": "オーディオドライバ",
            "使用系统音量键控制内建扬声器和外接显示器": "システム音量キーで内蔵スピーカーと外部ディスプレイを制御",
            "安装": "インストール",
            "卸载": "アンインストール",
            "音频驱动操作失败": "オーディオドライバの操作に失敗しました",
            "软件音量": "ソフトウェア音量",
            "软件音量操作失败": "ソフトウェア音量の操作に失敗しました",
            "音频兼容输出": "オーディオ互換出力",
            "音频兼容输出操作失败": "オーディオ互換出力の操作に失敗しました",
            "需要 macOS 14.2 或更高版本": "macOS 14.2以降が必要です",
            "未启用": "無効",
            "停用": "無効にする",
            "启用": "有効にする",
            "当前输入法": "現在の入力ソース",
            "重启输入法": "入力ソースを再起動",
            "输入法重启失败": "入力ソースの再起動に失敗しました",
            "关于": "情報",
